      ...
      <div className="flex-wrap flex gap-4 justify-center">
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          ...
          <div className="flex  gap-2 text-sm">
            ...
            <div className="text-gray-500">اخر شهر</div>
          </div>
        </div>
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2">احدث المستخدمين</h1>
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=users"}>انظر للكل</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell>صورة المستخدم</Table.HeadCell>
              <Table.HeadCell>اسم</Table.HeadCell>
            </Table.Head>
            {users &&
              users.map((user) => (
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2">احدث التعاليق</h1>
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=comments"}>انظر للكل</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2">احدث المنتجات</h1>
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=products"}>انظر للكل</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
              ...
              <Table.HeadCell>نوع المنتج</Table.HeadCell>
            </Table.Head>
            {products &&
